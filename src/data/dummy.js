...
export const EditorData = () => (
  <div>
    <h3>
    Shoppable content
This type of content allows customers to buy products directly from the content, such as social media posts, videos, or magazines. Some examples of shoppable content include: 
Shoppable social media posts: Businesses can add products to their social media posts, such as Instagram reels or TikTok videos. 
Shoppable videos: Businesses can film walkthroughs of retail stores or popup events, and then make certain products shoppable. 
Shopping experience
The shopping experience is important for businesses because it can influence customers' purchasing decisions. 86% of consumers are willing to pay more for a great shopping experience. 
Online shopping
Online shopping is a form of electronic commerce that allows customers to buy goods or services from a seller over the internet. 
Diversifying content types
Shopping businesses can diversify their content mix by using different formats, such as video, audio, interactive quizzes, polls, surveys, competitions, and giveaways.  </h3>
  </div>
);
